...
@property (nonatomic, strong) JetPaySDK *jetpaySDK;
@end
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    // Init SDK
    self.jetpaySDK = [[JetPaySDK alloc] init];
    ...
    [self.jetpaySDK presentPaymentAt:self paymentOptions:paymentOptions completionHandler:^(PaymentResult *result) {
        NSLog(@"SDK finished with status %ld", (long)result.status);
